...
export function Appearance({changeBlur, changeOpacity, blur_, opacity_}: Props) {
    ...
    return <div className='w-[80%]'>
        ...
        <div className='flex items-center'>
            <div className='relative w-[80%] h-2 bg-[#3d3e3b]'>
                ...
                <span onClick={() => {
                    ...
                    changeOpacity('0')
                      ...
                      className='absolute bottom-[-2px] h-3 w-1 bg-[#525351] rounded-full'></span>
                <span onClick={() => {
                    setOP('50');
                    changeOpacity('50')
                }}
                      className='absolute left-[calc(50%-2px)] bottom-[-2px] h-3 w-1 bg-[#525351] rounded-full'></span>
                <span onClick={() => {
                    setOP('100');
                    changeOpacity('100');
                }}
                      className='absolute right-0 bottom-[-2px] h-3 w-1 bg-[#525351] rounded-full'></span>
            </div>
            <div className='w-[20%] flex items-center'>
                <div className='flex'>
                    <input min={0} max={100}
                           className='text-gray-50 w-[100%] bg-[#3b3b3b] h-5 text-center text-[0.875rem] relative pl-1.5 rounded-md ml-2 px-1'
                           value={opacity}
                           onChange={e => {
                               setOP(e.target.value);
                               changeOpacity(e.target.value)
                ...
                <span className='ml-1 text-gray-50'>%</span>
            </div>
        </div>
